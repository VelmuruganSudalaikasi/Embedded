...
void RT_Scanning(void){
    ...
    result=RCREG;
    switch(result){
      case 'A': TXREG='a'; _delay((unsigned long)((100)*(6000000/4000.0))); break;
      case 'B': TXREG='b'; _delay((unsigned long)((100)*(6000000/4000.0))); break;
      case 'C': TXREG='c'; _delay((unsigned long)((100)*(6000000/4000.0))); break;
      case 'D': TXREG='d'; _delay((unsigned long)((100)*(6000000/4000.0))); break;
    }RCIF=0;
    }
}
