...
void RX_Scanning(void){
    ...
    if(RCIF==1){
        ...
        Lcd_cmd(0xC3);
        switch(result){
            case 'a': Lcd_data('a');_delay((unsigned long)((100)*(6000000/4000.0))); break;
            case 'b': Lcd_data('b');_delay((unsigned long)((100)*(6000000/4000.0))); break;
            case 'c': Lcd_data('c');_delay((unsigned long)((100)*(6000000/4000.0))); break;
            case 'd': Lcd_data('d');_delay((unsigned long)((100)*(6000000/4000.0))); break;
        }
