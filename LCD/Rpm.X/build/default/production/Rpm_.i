...
void main(){
    ...
    {
        Scanninginput();
        _delay((unsigned long)((1000)*(600000/4000.0)));
    }
}
...
void Configuration(){
    ...
    _delay((unsigned long)((100)*(600000/4000.0)));
...
void Splitingcharacter(int speed){
    ...
    d1 = (speed / 1000);
    d2 = ((speed - (1000 * d1)) / 100);
    d3 = ((speed - ((100 * d2) + (1000 * d1))) / 10);
    d4 = (speed - ((1000 * d1) + (100 * d2) + (10 * d3)));

    Lcd_instruction(0x88);
    Lcd_displaydata((unsigned char)(48 + d1));
    Lcd_displaydata((unsigned char)(48 + d2));
    Lcd_displaydata((unsigned char)(48 + d3));
    Lcd_displaydata((unsigned char)(48 + d4));
}
