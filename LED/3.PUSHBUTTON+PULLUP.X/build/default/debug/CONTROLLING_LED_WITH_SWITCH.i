# 1 "CONTROLLING_LED_WITH_SWITCH.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "CONTROLLING_LED_WITH_SWITCH.c" 2
...
# 19 "CONTROLLING_LED_WITH_SWITCH.c" 2


unsigned char* dir_b=(unsigned char*)0x86,dir_c=(unsigned char*)0x87,op_reg=(unsigned char*)0x81;
unsigned char* data_b=(unsigned char*)0x06,*data_c=(unsigned char*)0x07;
unsigned char val;
void main(){
    *dir_b=0xF0;
    *dir_c=0x00;
